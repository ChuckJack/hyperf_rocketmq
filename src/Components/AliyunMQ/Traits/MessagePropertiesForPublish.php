<?php
namespace Timebug\Rocketmq\Components\AliyunMQ\Traits;
...
trait MessagePropertiesForPublish
{
    ...
    public function writeMessagePropertiesForPublishXML(XMLWriter $xmlWriter): void
    {
    ...
    private function checkPropValid(): void
    {
